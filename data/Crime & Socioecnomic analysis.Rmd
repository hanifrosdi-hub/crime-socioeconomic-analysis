...
We load the CSV files and clean column names.
```{r}
...
Check column names, structure, and missing values.
```{r}
...
Handle missing median income and prepare output folders.
# Fill missing median income with mean of income_mean
...
Aggregate crime per state-year and socioeconomic indicators.

# Crime per state-year
...
# State-level socioeconomic indicators
...
7.5 High Crime Despite Good Socioeconomic Conditions
```{r}
